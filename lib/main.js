...
const {panelCommand, CtxMenuOptions, DockOptions, HotkeyOptions, MenuOptions} = require("./app/opquast-dock");
const webExtension = require("sdk/webextension");

var DesktopHotkey = null;
var DesktopMenu = null;

var webExtBrowser = null;
...
exports.main = function(aOptions, aCallback) {
    // let's initialize the web extension
    webExtension.startup().then(api => {
        webExtBrowser = api.browser;
        webExtBrowser.runtime.onMessage.addListener(webExtMessageListener);
